...
ИНФОРМАЦИЯ О БАНКЕ И ИСЛАМСКИХ ФИНАНСАХ:
Zaman Bank - первый цифровой исламский банк в Казахстане.
Основные услуги:
- Онлайн-финансирование без залога
- Вклады "Вакала" с доходностью до 20%
- Исламская цифровая карта

Ключевые термины исламских финансов:
- Риба: Запретная процентная прибыль в исламе.
- Мурабаха: Продажа с наценкой, где банк покупает товар и перепродает его клиенту с оговоренной наценкой.
- Иджара: Аренда имущества или оборудования, где банк остается владельцем, а клиент выплачивает арендные платежи и может выкупить актив в конце срока.
- Халяль: Все, что разрешено по законам шариата.
- Гарар: Неопределенность и спекуляция в сделках.
- Мейсир: Азартные игры и спекуляции, где прибыль основана на случайности.
- Мудараба: Партнерство, где один партнер предоставляет капитал, а другой - управление и труд.
- Закят: Обязательный годовой налог на имущество мусульман в пользу бедных.
- Харам: Все, что запрещено в исламе.
- Кард Хасан: Беспроцентный заем на благие цели.
